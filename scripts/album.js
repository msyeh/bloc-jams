var setSong = function(songNumber) {
    ...
    currentSoundFile = new buzz.sound(currentSongFromAlbum.audioUrl, { //new Buzz sound object
         formats: [ 'mp3' ], //pass in settings object with two defined properties
         preload: true
     });
...
var nextSong = function() {
    ...
    setSong(currentSongIndex + 1); //set current song number to be 1 more than song index
    currentSoundFile.play();
